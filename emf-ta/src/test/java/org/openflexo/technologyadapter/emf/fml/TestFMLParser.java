...
public class TestFMLParser {
	...
	public static Collection<Object[]> generateData() {
		...
		// return Resources.getMatchingResource(ResourceLocator.locateResource("FML"), ".fml");
	}
	...
	@Test
	public void parseFMLResource() throws ModelDefinitionException, IOException, ParseException {
	...
	protected static FlexoServiceManager instanciateTestServiceManager() {
		...
		// Activate FML, FML@RT and Diagram technology adapters
		...
		taService.activateTechnologyAdapter(taService.getTechnologyAdapter(EMFTechnologyAdapter.class), true);
